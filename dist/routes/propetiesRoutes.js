...
const getPropertyLeasesController_1 = __importDefault(require("../controllers/propeties/getPropertyLeasesController"));
...
router.get("/:propertyId/leases", getPropertyLeasesController_1.default);
